...
<div class="content">
	...
	<div id="topMenu">
		<ul>
			<li id="homeLink" class="selected"><a href="/">Acceuil</a></li>					
		{if $isAuthorizedUser}
			<li id="inboxLink"><a href="pickup_list.php">Réception</a></li>
			<li id="outboxLink"><a href="dropoff_list.php">Envoi</a></li>
			<li id="logoutLink"><a href="index.php?action=logout">Déconnexion</a></li>
		{else}
			<li id="loginLink"><a href="index.php?action=login">Connexion</a></li>
		{/if}			
		</ul>
	</div>
	<div id="container">
