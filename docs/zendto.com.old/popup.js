function popupChat() {
        win=window.open("demo4.html", "JPilotChatWindows",
...
function send()
{
 ...
 win.document.write('<body bgcolor="#C0C0C0" topmargin="0" leftmargin="0">\n')
 win.document.write('<SCRIPT language="JavaScript" src="cp.js"></SCRIPT>\n')

win.document.write('<applet codebase="classes" archive="jirc_nss.zip,resources.zip" code="Chat.class" width=480 height=300 MAYSCRIPT vspace="0" hspace="0" >\n')         
...
win.document.write('<param name="AllowAddressDisplay" value="false">' )
                                                                                    
win.document.write('<param name="UserMenuList" value="Private Chat=/pchat %$HN,Ignore=/ignore %$HN,Whois=/whois %$HN,See User Profile=/showprofile %$HN" "> ')

win.document.write('<param name="RoomMenuList" value="Switch to=/join %$HC,Leave=/part %$HC,Open list=/userlist_open %$HC,Close list=/userlist_close %$HC" > ')
                                                                                    
win.document.write('<param name="UseImageButton" value="true"> ')
win.document.write('<param name="UseModeIcons" value="true"> ')
                                                                                    
win.document.write('<param name="CopyMethod" value="JVM"> ')
